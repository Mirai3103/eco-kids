...
#include <VectorIconsFontAwesome.h>
...
auto module_VectorIconsFontAwesome = VectorIconsFontAwesome_ModuleProvider(moduleName, params);
if (module_VectorIconsFontAwesome != nullptr) {
return module_VectorIconsFontAwesome;
}
